...
<head>
    ...
    fbq('init', '1950406052273983');
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=1950406052273983&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->
</head>
<body>
    ...
    <div class="sucesso-container">
        ...
        <div class="btns">
            <a class="btn-whatsapp" href="https://wa.me/?text=Acabei%20de%20me%20inscrever%20em%20um%20curso%20gratuito%20incr%C3%ADvel!%20Garanta%20sua%20vaga%20tamb%C3%A9m%20e%20venha%20transformar%20sua%20carreira%20comigo.%20Inscreva-se%20aqui:%20https://movimenta-igraja-jardim-maravilha-guaratiba.onrender.com" target="_blank">&#128241; COMPARTILHAR NO WHATSAPP</a>
...
<body>
        ...
        <form id="form-curso" method="POST" action="/curso" autocomplete="off">
            <div class="form-group">
                ...
                <select id="local" name="local" required>
                    ...
                    <option value="IGREJA JARDIM MARAVILHA - GUARATIBA">IGREJA JARDIM MARAVILHA - GUARATIBA</option>
                </select>
            </div>
            <div class="form-group">
    ...
    const turmasData = {
        'AUXILIAR DE COZINHA': [{
            id: 'TURMA 06',
            turma: 'AUXILIAR DE COZINHA - TURMA 06',
            horario: 'Segunda e Quarta | 9h até 11h', // ID: TURMA 01
            data_inicio: '16/03/2026', // ID: PERÍODO 01
            encerramento: '15/04/2026', // ID: INÍCIO 01
            endereco: 'Rua Jaburu, 04 - Guaratiba' // ID: ENCERRAMENTO 01
        }],
        'GARÇOM': [{
            id: 'TURMA 07',
            turma: 'GARÇOM - TURMA 07',
            horario: 'Segunda e Quarta | 13h até 15h', // ID: TURMA 02
            data_inicio: '16/03/2026', // ID: PERÍODO 02
            encerramento: '15/04/2026', // ID: INÍCIO 02
            endereco: 'Rua Jaburu, 04 - Guaratiba' // ID: ENCERRAMENTO 02
        }],
        'CUMIN': [{
            id: 'TURMA 07',
            turma: 'CUMIN - TURMA 07',
            horario: 'Segunda e Quarta | 16h até 18h', // ID: TURMA 03
            data_inicio: '16/03/2026', // ID: PERÍODO 03
            encerramento: '15/04/2026', // ID: INÍCIO 03
            endereco: 'Rua Jaburu, 04 - Guaratiba' // ID: ENCERRAMENTO 03
        }]
    };
